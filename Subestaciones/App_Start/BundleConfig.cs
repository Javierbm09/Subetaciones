...
namespace Subestaciones
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Style/Bootstrap").Include("~/Content/vendors/bootstrap/dist/css/bootstrap.min.css"));
            bundles.Add(new StyleBundle("~/Style/Fonts").Include("~/Content/vendors/font-awesome/css/font-awesome.min.css"));
            bundles.Add(new StyleBundle("~/Style/NProgress").Include("~/Content/vendors/nprogress/nprogress.css"));
            ...
            bundles.Add(new StyleBundle("~/Style/DataTables").Include(
                      ...
                      "~/ Scripts/custom/Datatables/Select-1.2.6/css/select.bootstrap.min.css"
                      ));
            ...
            bundles.Add(new ScriptBundle("~/Script/DataTables").Include(
                ...
                "~/Scripts/custom/Datatables/Select-1.2.6/js/dataTables.select.js"
                ));
