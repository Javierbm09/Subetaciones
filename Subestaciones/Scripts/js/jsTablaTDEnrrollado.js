...
var _sourceTDEnrrolladoAction =
{
    ...
    deleterow: function (rowid, newdata, commit) {
        $.ajax({
            dataType: 'json',
            cache: false,
            url: baseUrl + "Sub_MttoTFuerza/EliminarTDEnrrollado",
            type: "POST",
            data: {
                idTDE: idTDE
            },
...
var _columnsTDEnrrolladoAction = [
    ...
    { text: 'Tangente Delta', columntype: 'textbox', filtertype: 'number', dataField: 'TangenteDelta', align: 'left', width: '20%' },
    {
        text: '', datafield: 'addButtonColumn', columntype: 'button', width: '20%', cellsrenderer: function () {
            ...
            editrow = row;
            filaSeleccionada = $("#TablaTDEnrrollado").jqxGrid('getrowid', editrow);
            swal({
                ...
                if (isConfirm) {
                    $("#TablaTDEnrrollado").jqxGrid('deleterow', filaSeleccionada);
