    ...
    switch (culture) {
        ...
        case "es":
            localization =
                ...
                groupsheaderstring : "Arrastre una columna para que se agrupe por ella",
                ...
                filterstringcomparisonoperators : ['vacio', 'no vacio', 'contenga', 'contenga(coicidir Mayusculas/Minusculas)',
                ...
                filternumericcomparisonoperators : ['=', '!=', '<', '<=', '>', '>=', 'null', 'no null'],
                filterdatecomparisonoperators : ['=', '!=', '<', '<=', '>', '>=', 'null', 'no null'],
