var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", baseUrl + "Content/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", baseUrl + "Content/assets/frontend/onepage/img/logo/" + color + ".png");
        }
